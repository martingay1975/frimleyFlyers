...
namespace Strava.Clients
{
    ...
    public class AthleteClient : BaseClient
    {
		...
		public List<ActivitySummary> GetActivities(string athleteId)
	    {
			string getUrl = string.Format("{0}/activities?access_token={1}", Endpoints.Athlete,  Authentication.AccessToken);
